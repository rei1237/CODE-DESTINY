  ...
  for (var pi = 0; pi < 12; pi++) {
    ...
    function parseStarRows(list, borrowedByTag){
      return (list || []).map(function(raw){
        ...
        var strength = zwComputeStarStrength(starName, gZhi, borrowedFlag) || '리';
        return {
          name: starName,
          strength: strength,
...
function renderAstroInsight() {
  var birth = window._astroBirth || window._ziweiBirth || { year:2000, month:1, day:1, hour:12, minute:0, lat:37.6, lon:127.0, tz:9 };
    ...
    var vmFallbackByGap = {
      ...
      2:'금성-화성이 육합 성향이라 관계 운행과 실행력이 비교적 자연스럽게 연결됩니다.',
    ...
    var retroFocusText = retroPlanets.length
      ? ('역행 행성은 '+retroPlanets.join(', ')+'로 확인되며, 해당 행성 영역은 외부 확장보다 재검토/재정렬 천기가 유리합니다.')
...
/* ─────── 자미두수 12궁 심층 분석 요약 ─────── */
var ZW_BRIGHTNESS={
  '자미':{'子':'평','丑':'묘','寅':'왕','卯':'왕','辰':'묘','巳':'평','午':'왕','未':'묘','申':'평','酉':'평','戌':'묘','亥':'평'},
  '천기':{'子':'평','丑':'함','寅':'왕','卯':'왕','辰':'평','巳':'묘','午':'함','未':'평','申':'묘','酉':'왕','戌':'평','亥':'묘'},
  '태양':{'子':'함','丑':'함','寅':'묘','卯':'왕','辰':'왕','巳':'왕','午':'묘','未':'왕','申':'평','酉':'함','戌':'함','亥':'함'},
  '무곡':{'子':'묘','丑':'왕','寅':'평','卯':'평','辰':'묘','巳':'평','午':'평','未':'평','申':'왕','酉':'묘','戌':'함','亥':'평'},
  '천동':{'子':'왕','丑':'평','寅':'평','卯':'묘','辰':'함','巳':'평','午':'함','未':'묘','申':'평','酉':'평','戌':'평','亥':'왕'},
  ...
  '탐랑':{'子':'왕','丑':'평','寅':'묘','卯':'평','辰':'평','巳':'묘','午':'왕','未':'평','申':'묘','酉':'묘','戌':'평','亥':'묘'},
  '거문':{'子':'왕','丑':'묘','寅':'평','卯':'함','辰':'함','巳':'묘','午':'함','未':'묘','申':'묘','酉':'평','戌':'함','亥':'묘'},
  '천상':{'子':'묘','丑':'묘','寅':'왕','卯':'평','辰':'왕','巳':'평','午':'묘','未':'묘','申':'왕','酉':'평','戌':'묘','亥':'평'},
  '천량':{'子':'평','丑':'묘','寅':'묘','卯':'평','辰':'묘','巳':'평','午':'묘','未':'함','申':'묘','酉':'평','戌':'묘','亥':'함'},
  '칠살':{'子':'묘','丑':'평','寅':'묘','卯':'평','辰':'묘','巳':'평','午':'묘','未':'왕','申':'묘','酉':'평','戌':'묘','亥':'평'},
  '파군':{'子':'왕','丑':'함','寅':'묘','卯':'함','辰':'묘','巳':'함','午':'왕','未':'함','申':'묘','酉':'함','戌':'묘','亥':'평'}
};
// 보조성/흉성의 지지별 세기표(전통 배치표 기반 고정 규칙)
var ZW_MINOR_BRIGHTNESS={
  '좌보':{'子':'왕','丑':'묘','寅':'왕','卯':'묘','辰':'묘','巳':'리','午':'왕','未':'묘','申':'왕','酉':'리','戌':'왕','亥':'리'},
  '우필':{'子':'왕','丑':'묘','寅':'왕','卯':'리','辰':'왕','巳':'리','午':'왕','未':'묘','申':'왕','酉':'리','戌':'묘','亥':'리'},
  '문창':{'子':'리','丑':'왕','寅':'묘','卯':'왕','辰':'리','巳':'왕','午':'약','未':'왕','申':'묘','酉':'왕','戌':'리','亥':'왕'},
  '문곡':{'子':'리','丑':'왕','寅':'묘','卯':'왕','辰':'리','巳':'왕','午':'리','未':'왕','申':'리','酉':'왕','戌':'리','亥':'왕'},
  '녹존':{'子':'묘','丑':'왕','寅':'리','卯':'왕','辰':'리','巳':'약','午':'묘','未':'왕','申':'리','酉':'왕','戌':'리','亥':'약'},
  '천마':{'子':'왕','丑':'리','寅':'묘','卯':'리','辰':'왕','巳':'리','午':'묘','未':'리','申':'왕','酉':'리','戌':'묘','亥':'리'},
  '경양':{'子':'약','丑':'리','寅':'왕','卯':'묘','辰':'왕','巳':'리','午':'약','未':'리','申':'왕','酉':'묘','戌':'묘','亥':'리'},
  '타라':{'子':'약','丑':'약','寅':'리','卯':'왕','辰':'묘','巳':'왕','午':'리','未':'약','申':'약','酉':'리','戌':'왕','亥':'약'},
  '화성':{'子':'약','丑':'왕','寅':'왕','卯':'묘','辰':'왕','巳':'리','午':'약','未':'리','申':'왕','酉':'묘','戌':'왕','亥':'리'},
  '영성':{'子':'약','丑':'리','寅':'묘','卯':'묘','辰':'왕','巳':'리','午':'약','未':'리','申':'왕','酉':'묘','戌':'왕','亥':'리'},
  '지공':{'子':'리','丑':'약','寅':'리','卯':'왕','辰':'묘','巳':'왕','午':'리','未':'리','申':'리','酉':'왕','戌':'묘','亥':'왕'},
  '지겁':{'子':'리','丑':'약','寅':'리','卯':'리','辰':'리','巳':'왕','午':'리','未':'약','申':'리','酉':'왕','戌':'묘','亥':'왕'}
};
function zwNormalizeStrength(level){
  var lv = (level || '').trim();
  if(lv === '평' || lv === '득' || lv === '이' || lv === '리') return '리';
  if(lv === '한' || lv === '불') return '한';
  if(lv === '약') return '함';
  if(lv === '함') return '함';
...
function zwComputeStarStrength(starName, zhi, isBorrowed){
  var raw = null;
  if(ZW_BRIGHTNESS[starName] && ZW_BRIGHTNESS[starName][zhi]) raw = ZW_BRIGHTNESS[starName][zhi];
  else if(ZW_MINOR_BRIGHTNESS[starName] && ZW_MINOR_BRIGHTNESS[starName][zhi]) raw = ZW_MINOR_BRIGHTNESS[starName][zhi];
  else return null;
  var lv = zwNormalizeStrength(raw);
  if(!isBorrowed) return lv;
  var down = {'묘':'왕','왕':'리','리':'리','한':'한','함':'함'};
  return down[lv] || lv;
}
var ZW_GUNG_DEF={
  '명궁':'선천 자아·기질·운명의 뿌리',
...
function buildZwSummaryTableHtml(palace) {
  ...
  function getEffectiveBr(sn,z,isBorrowed,brHint){
    var b=zwNormalizeStrength(brHint || zwComputeStarStrength(sn,z,isBorrowed) || '리');
    return b;
  }
  function getBrTag(b,isBorrowed){
    var c={'묘':'#4ade80','왕':'#60a5fa','리':'#94a3b8','한':'#f59e0b','함':'#f87171'};
    var bg={'묘':'rgba(74,222,128,0.15)','왕':'rgba(96,165,250,0.15)','리':'rgba(148,163,184,0.1)','한':'rgba(245,158,11,0.15)','함':'rgba(248,113,113,0.15)'};
  ...
  function calcStrengthTier(mainMeta,zhi){
    ...
    // 사용자 기준: ◎(묘) > O(왕) > △(리) > ▲(한/불) > X(함)
    var scoreMap={묘:5,왕:4,리:3,한:2,함:1};
  ...
  function genSummary(gungName,mainMeta,zhi,sh,auxStars){
    ...
    var brightPart={묘:'강한 발현',왕:'최상급 발현',리:'중간 발현',한:'저강도 발현',함:'제약 발현'}[tier]||'작동';
    ...
    else if(tier==='한' || tier==='함') advPart=' ☛ '+ZW_GUNG_DEF[gungName]+' 에너지 손실 주의. 무리한 확장보다 복구-정비 천기가 필요합니다.';
    else advPart=' ☛ '+ZW_GUNG_DEF[gungName]+' 안정 유지. 강제 확장 불필요';
    if(hasBorrowed) advPart += ' <span style="color:#facc15">(차성 차용궁: ◎(묘)→O(왕), O(왕)→△(리))</span>';
  ...
  for(var pi=0;pi<ZW_PALACE_ORDER.length;pi++){
    ...
    if(mainMeta.length){
      starsDisp=mainMeta.map(function(m){
        var b2=ZW_BRIGHTNESS[m.name]?getEffectiveBr(m.name,zhi,m.isBorrowed,m.brHint):zwNormalizeStrength(m.brHint||'리');
  ...
  var legendHtml = '<div style="padding:8px 12px 6px;font-size:0.71rem;color:#64748b;border-bottom:1px solid rgba(255,255,255,0.06);display:flex;gap:14px;flex-wrap:wrap">'
    +'<span>밝기: <b style="color:#4ade80">◎(묘)</b>=100% 최상 · <b style="color:#60a5fa">O(왕)</b>=85% 우수 · <b style="color:#94a3b8">△(득/이/평)</b>=50~70% 보통 · <b style="color:#f59e0b">▲(한/불)</b>=30% 약함 · <b style="color:#f87171">X(함)</b>=10% 미만</span>'
...
.gaeun-title { font-size: 0.95rem; color: #c4b5fd; margin-bottom: 15px; text-transform: uppercase; letter-spacing: 1px; font-weight: 600; }
  ...
  function _zwGetEffectiveBr(name, zhi, borrowed){
    return zwComputeStarStrength(name, zhi, borrowed) || '리';
  }
  ...
  if(!window._handleZwClick) {
    ...
    window._runZwCompatibility = function() {
      ...
      var actionGuide = bestCategory.key === '사업 궁합' || bestCategory.key === '직장 궁합'
        ? '이 시기에는 함께 소규모 공동 프로젝트를 시작해 역할 분업을 실전 검증해 보세요.'
        : (bestCategory.key === '연애 궁합' || bestCategory.key === '결혼 궁합'
          ? '이 시기에는 함께 여행+생활규칙 합의(돈/시간/연락 템포)를 동시에 시작해 보세요.'
          : '이 시기에는 함께 공부/운동 루틴을 묶어 관계 리듬을 안정화해 보세요.');
  ...
  var mainSt = mainStMeta.map(function(m){ return m.name; });
        ...
        if (mainSt.length > 0) {
          ...
          if (mainStMeta.some(function(m){ return m.isBorrowed; })) {
            coreLaw += ' <span style="color:#facc15">(차성 차용궁: ◎(묘)→O(왕), O(왕)→△(리))</span>';
          }
        } else {
...
function buildFortuneHTML(res, p){
  ...
  if(res.adviceItems.length===0){
    html+=NEO_MODE
      ?'<div class="fr-row fr-good"><div class="fr-row-title">📊 충·형 없음 — 중립 구간</div><div class="fr-row-body">별다른 충·형 없이 에너지가 고요하다. 원래 계획대로 실행하는 날로 정렬해라.</div></div>'
  ...
  html+='<div class="fr-row fr-good"><div class="fr-row-title">'+(NEO_MODE?'📈 오늘의 기운 정렬':'💡 오늘의 행운 팁')+'</div>';
  html+='<div class="fr-row-body">'+(NEO_MODE?'🎨 최적 색상: ':'🎨 행운 색상: ')+'<b>'+res.lt.color+'</b><br>'+(NEO_MODE?'🧭 실행 천기: ':'🧭 행운 행동: ')+res.lt.action+'</div></div>';
