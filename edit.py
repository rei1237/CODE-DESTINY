...
with open('js/saju-engine.js', 'r', encoding='utf-8') as f:
    text = f.read()
...
if targetStr in text:
    with open('js/saju-engine.js', 'w', encoding='utf-8') as f:
        f.write(text.replace(targetStr, replaceStr))
